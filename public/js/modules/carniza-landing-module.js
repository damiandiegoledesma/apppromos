(function () {
  ...
  function openWhatsApp(kind) {
    const messages = {
      customer: "Hola AppPromos, tengo una carnicería y quiero probar la app para vender por WhatsApp.",
      partner: "Hola AppPromos, me interesa hablar sobre alianza, socios estratégicos o inversión."
    };
    window.open(buildWhatsAppUrl(messages[kind] || messages.customer), "_blank", "noopener,noreferrer");
    closePanel();
  }
  ...
  function render() {
    ...
    root.innerHTML = `
      <button type="button" class="carniza-landing-fab" aria-label="Abrir Carniza">
        <span class="carniza-landing-fab-icon" aria-hidden="true">🐮</span>
      ...
      <div class="carniza-landing-panel" role="dialog" aria-label="Carniza Landing">
        <div class="carniza-landing-head">
          <div class="carniza-landing-brand">
            <div class="carniza-landing-avatar" aria-hidden="true">🐮</div>
            <div>
        ...
        <div class="carniza-landing-body">
          ...
          <div class="carniza-landing-actions">
            ...
            <button type="button" class="carniza-landing-action whatsapp" data-carniza-landing-action="whatsapp">
              <span>📲 Hablar por WhatsApp</span><span aria-hidden="true">›</span>
            </button>
            <button type="button" class="carniza-landing-action" data-carniza-landing-action="partner">
              <span>🤝 Socios / inversores</span><span aria-hidden="true">›</span>
            </button>
          </div>
        </div>
  ...
  function bindEvents() {
    document.addEventListener("click", (event) => {
      ...
      if (action === "whatsapp") return openWhatsApp("customer");
      if (action === "partner") return openWhatsApp("partner");
