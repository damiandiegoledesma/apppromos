        ...
        <section class="card guided-builder__work">
          <div class="guided-section-head">
            <div>
              ...
              ${state.canWrite ? `<p>Revisá la vista comercial. Si está bien, guardá la oferta y mandala por WhatsApp.</p>` : `<p>Podés armar y revisar ofertas. Para guardarlas, ponete al día.</p>`}
            </div>
          ...
          <div class="guided-actions guided-actions--sell">
            <button type="button" class="guided-primary guided-primary--save" data-action="save-offer" ${state.ui.isSaving || !state.canWrite ? "disabled" : ""}>
              ${!state.canWrite ? "🔒 Para guardar, ponete al día" : state.ui.isSaving ? "⏳ Guardando..." : "💾 Guardar oferta"}
            </button>
...
function injectGuidedBuilderStyles() {
  ...
  style.textContent = `
    ...
    .guided-discount-inline { display:flex; align-items:center; gap:8px; padding:8px 10px; border-radius:18px; background:linear-gradient(135deg,#eff6ff,#f8fbff); border:1px solid #bfdbfe; box-shadow:0 8px 18px rgba(4,119,242,.08); }
    .guided-discount-inline label { font-size:12px; font-weight:1000; color:#0b63ce; letter-spacing:.01em; }
    .guided-discount-inline input { width:82px; min-height:46px; text-align:center; font-weight:1000; font-size:18px; color:#0f172a; border:1px solid #93c5fd; border-radius:16px; background:#ffffff; box-shadow:inset 0 1px 0 rgba(255,255,255,.9); }
    ...
    .guided-general-discount { margin-top:14px; padding:16px; border:1px solid #bfdbfe; border-radius:20px; background:linear-gradient(135deg,#eff6ff,#ffffff); display:flex; justify-content:space-between; align-items:center; gap:14px; box-shadow:0 10px 24px rgba(4,119,242,.08); }
    .guided-general-discount strong, .guided-general-discount span { display:block; }
    .guided-general-discount span { color:#475569; font-size:13px; margin-top:3px; font-weight:750; }
    .guided-discount-control { display:flex; align-items:center; gap:10px; padding:8px 10px; border-radius:18px; background:#fff; border:1px solid #bfdbfe; }
    .guided-discount-control input { width:110px; min-height:48px; text-align:center; font-weight:1000; font-size:19px; color:#0f172a; border:1px solid #93c5fd; border-radius:16px; background:#f8fbff; }
    .guided-discount-control span { font-size:15px; font-weight:1000; color:#0b63ce; }
